...
// exchanges row portion/column portion with 4 neighbours //
...
// applies implicit solve of 5 point stencil  for one iteration //
...
// iterates until convergance, applying a Jacobi relacation to the 5 point stencil //
